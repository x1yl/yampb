...
@tree.command(
    ...
    guild=discord.Object(id=942802471615606895),
)
async def RockPaperScissors(interaction: discord.Interaction, choice: str):
    ...
    if b == choice:
        ...
        if (b == "rock") and (choice == "paper"):
            await interaction.response.send_message(
                f"I choose {b}, gg you win <a:8922_Letter_W:945766211436818525>!"
            )
        elif (b == "rock") and (choice == "scissor"):
            await interaction.response.send_message(
                f"I choose {b}, you lose <a:6141_Letter_L:945766211520708738>"
            )
...
async def on_message(message):
    if message.content == "!connect4":
        await message.channel.send(
            "<:c4_1:1008273636102250558><:c4_2:1008273628346990622><:c4_3:1008273620423938128><:c4_4:1008273612714803310><:c4_5:1008273609275486218><:c4_6:1008273605399953469><:c4_7:1008273603374096474>\n ",
            reference=message,
        )
    if message.content == "!rock":
        ...
        if a == 1:
            await message.channel.send(
                "I choose rock, draw. Try again!", reference=message
            )
        elif a == 2:
            await message.channel.send(
                "I choose paper, you lost <a:6141_Letter_L:945766211520708738>",
                reference=message,
            )
        elif a == 3:
            await message.channel.send(
                "I choose scissors, gg you win <a:8922_Letter_W:945766211436818525>!",
                reference=message,
            )
    if message.content == "!paper":
        ...
        if a == 1:
            await message.channel.send(
                "I choose rock, gg you win <a:8922_Letter_W:945766211436818525>!",
                reference=message,
            )
        elif a == 2:
            await message.channel.send(
                "I choose paper, draw. Try again!", reference=message
            )
        elif a == 3:
            await message.channel.send(
                "I choose scissors, you lost <a:6141_Letter_L:945766211520708738>",
                reference=message,
            )
    if message.content == "!scissors":
        ...
        if a == 1:
            await message.channel.send(
                "I choose rock, you lost <a:6141_Letter_L:945766211520708738>",
                reference=message,
            )
        elif a == 2:
            await message.channel.send(
                "I choose paper, gg you win <a:8922_Letter_W:945766211436818525>!",
                reference=message,
            )
        elif a == 3:
            await message.channel.send(
                "I choose scissors, draw. Try again!", reference=message
            )
...
async def ping(ctx):
    ...
    embed.set_image(
        url="https://media.discordapp.net/attachments/990405465353621574/992146968669323264/d1d286e18fda97d0a7e53cc96a12337d.jpg?width=614&height=585"
    )
...
async def gender(ctx):
    ...
    embed.set_image(
        url="https://media.discordapp.net/attachments/990405465353621574/992147364154445954/829208e16216e60eb7f7f480add25d00.jpg?width=614&height=585"
    )
    await ctx.send(embed=embed)
    embed2 = discord.Embed(
        title="",
...
async def uploaders(ctx):
    ...
    embed.set_image(
        url="https://media.discordapp.net/attachments/990405465353621574/992147461042884731/1fb748e7353850ce7e78d3ac24dfa850.jpg?width=614&height=585"
    )
    await ctx.send(embed=embed)
    embed2 = discord.Embed(
        title="",
...
async def dm(ctx):
    ...
    embed.set_image(
        url="https://media.discordapp.net/attachments/990405465353621574/992147104006938734/27530a7552aeef0c70318387e098b2b1.jpg?width=614&height=585"
    )
    await ctx.send(embed=embed)
    embed2 = discord.Embed(
        title="",
...
async def age(ctx):
    ...
    embed.set_image(
        url="https://media.discordapp.net/attachments/990405465353621574/992147404474302464/20a5a613e068dad10c47b9122fe795a4.jpg?width=614&height=585"
    )
    await ctx.send(embed=embed)
    embed2 = discord.Embed(
        title="",
